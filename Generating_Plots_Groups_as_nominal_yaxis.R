...
# Gradientintervalplot - Groups as nominal y-axis ####
ggplot(data, aes(Testscore, Condition)) + 
  stat_gradientinterval() + 
  xlim(c(0, 100)) + 
  theme_ipsum() + 
  labs(title = "Gradientinterval Plot", subtitle = "Groups as nominal y-axis")

ggsave(
  file = "plots/gradientintervalplot_groups_as_nominal_yaxis.svg",
  width = 6,
  height = 6,
  device = "svg"
)
...
# Boxplot - Groups as nominal y-axis ####
ggplot(data, aes(Testscore, Condition)) + 
  geom_boxplot() + 
  xlim(c(0, 100)) + 
  theme_ipsum() + 
  labs(title = "Box Plot", subtitle = "Groups as nominal y-axis")

ggsave(
  file = "plots/boxplot_groups_as_nominal_yaxis.svg",
  width = 6,
  height = 6,
  device = "svg"
)
...
# Violinplot - Groups as nominal y-axis ####
ggplot(data, aes(Testscore, Condition)) + 
  geom_violin() + 
  xlim(c(0, 100)) + 
  theme_ipsum() + 
  labs(title = "Violin Plot", subtitle = "Groups as nominal y-axis")

ggsave(
  file = "plots/violinplot_groups_as_nominal_yaxis.svg",
  width = 6,
  height = 6,
  device = "svg"
)
...
# Density plot - Groups as nominal y-axis ####
ggplot(data, aes(Testscore, Condition)) + 
  geom_density_ridges() +
  xlim(c(0, 100)) + 
  theme_ipsum() + 
  labs(title = "Density Plot", subtitle = "Groups as nominal y-axis")

ggsave(
  file = "plots/densityplot_groups_as_nominal_yaxis.svg",
  width = 6,
  height = 6,
  device = "svg"
)
...
ggplot(data, aes(Testscore, Condition)) + 
  ...
  xlim(c(0, 100)) + 
  theme_ipsum() + 
  labs(title = "Halfeye Plot", subtitle = "Groups as nominal y-axis")

ggsave(
  file = "plots/halfeyeplot_groups_as_nominal_yaxis.svg",
  width = 6,
  height = 6,
  device = "svg"
)
...
# Slabintervals - Groups as nominal y-axis ####
ggplot(data,
  ...
  xlim(c(0, 100)) + 
  theme_ipsum() + 
  labs(title = "Slabintervals Plot", subtitle = "Groups as nominal y-axis") +
  theme(legend.position = "none")

ggsave(
  file = "plots/slabintervalsplot_groups_as_nominal_yaxis.svg",
  width = 6,
  height = 6,
  device = "svg"
)
...
# CDF Bar Plot - Groups as nominal y-axis ####
ggplot(data, aes(Testscore, Condition)) + 
  stat_cdfinterval() + 
  xlim(c(0, 100)) + 
  theme_ipsum() + 
  labs(title = "CDF Bar Plot", subtitle = "Groups as nominal y-axis")

ggsave(
  file = "plots/cdfbarplot_groups_as_nominal_yaxis.svg",
  width = 6,
  height = 6,
  device = "svg"
)
...
# Histograms - Groups as nominal y-axis ####
ggplot(data, aes(Testscore, Condition)) + 
  ...
  xlim(c(0, 100)) + 
  theme_ipsum() + 
  labs(title = "Histogram", subtitle = "Groups as nominal y-axis")

ggsave(
  file = "plots/histogram_groups_as_nominal_yaxis.svg",
  width = 6,
  height = 6,
  device = "svg"
)
...
ggsave(
  file = "plots/sinaplot_groups_as_nominal_yaxis.svg",
  width = 6,
  height = 6,
  device = "svg"
)
...
ggsave(
  file = "plots/rugplot_groups_as_nominal_yaxis.svg",
  width = 6,
  height = 6,
  device = "svg"
)
...
ggsave(
  file = "plots/raincloudplot_groups_as_nominal_yaxis.svg",
  width = 6,
  height = 6,
  device = "svg"
)
